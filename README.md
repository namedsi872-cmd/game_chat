...
对于
## 项目痛点：
类似于第五人格这类非对称竞技游戏的信息量大、角色机制复杂，玩家在实战后往往难以准确定位自己的问题，也缺少持续、个性化的训练反馈。传统攻略内容分散，无法结合玩家的具体对局、训练目标和历史进度提供帮助。
## 项目定位：
本项目以“AI 陪练”为核心，通过角色化陪伴、游戏知识库检索、会话记忆和训练引导，帮助玩家梳理对局思路、拆解操作问题，并形成连续的个性化训练过程。
## 项目简介
